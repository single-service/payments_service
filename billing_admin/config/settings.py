...
UNFOLD = {
    "SITE_TITLE": _("Billing Manager"),
    "SITE_HEADER": _("Billing Manager"),
    "LOGIN": {
        "image": lambda request: static("applications/assets/pngtree-mobile-payment-mobile.jpg"),
    },
    "SITE_SYMBOL": "payment",
    "SITE_FAVICONS": [
        {
            ...
            "sizes": "32x32",
            "type": "image/svg+xml",
            "href": lambda request: static("applications/assets/favicon.ico"),
        },
    ],
}